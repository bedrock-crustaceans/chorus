...
use bedrockrs::proto::v662::enums::{ChatRestrictionLevel, Difficulty, EditorWorldType, EducationEditionOffer, GamePublishSetting, GameType, GeneratorType, PacketCompressionAlgorithm, PlayStatus, PlayerPermissionLevel, SpawnBiomeType};
...
impl LoginHandler {
    pub async fn handle(mut unknown_conn: Connection<Unknown>) {
        ...
        conn.send(&[V944::StartGamePacket(StartGamePacket {
